...
`Roxygen` is an R package that includes templates and shortcuts for documenting packages. For shiny packages there is now [golem](https://engineering-shiny.org/golem.html). The `devtools` package is used for building and testing the functions you write and document with `Roxygen` templates.
...
This [template](https://gist.github.com/PurpleBooth/109311bb0361f32d87a2) README is a good starting point. 
