...
\hypersetup{
  pdftitle={Package Development in R for Predator Free New Zealand 2050},
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{$}\NormalTok{ git config }\SpecialCharTok{{-}{-}}\NormalTok{global user.name }\StringTok{"Your Name"}
\SpecialCharTok{$}\NormalTok{ git config }\SpecialCharTok{{-}{-}}\NormalTok{global user.email }\StringTok{"youremail@email.com"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{$}\NormalTok{ cd }\SpecialCharTok{\textasciitilde{}}\ErrorTok{/}\NormalTok{Documents}\SpecialCharTok{/}\NormalTok{R}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{$}\NormalTok{ git clone https}\SpecialCharTok{:}\ErrorTok{//}\NormalTok{GitHub.com}\SpecialCharTok{/}\NormalTok{Carlos\_Account}\SpecialCharTok{/}\NormalTok{repository\_name}\SpecialCharTok{/}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{$}\NormalTok{ cd }\SpecialCharTok{\textasciitilde{}}\ErrorTok{/}\NormalTok{Documents}\SpecialCharTok{/}\NormalTok{R}\SpecialCharTok{/}\NormalTok{repository\_name}
\SpecialCharTok{$}\NormalTok{ git add .}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\SpecialCharTok{$}\NormalTok{ cd }\SpecialCharTok{\textasciitilde{}}\ErrorTok{/}\NormalTok{Documents}\SpecialCharTok{/}\NormalTok{R}\SpecialCharTok{/}\NormalTok{repository\_name}
\SpecialCharTok{$}\NormalTok{ git commit }\SpecialCharTok{{-}}\NormalTok{m }\StringTok{"Fixed small bug"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{$}\NormalTok{ git push origin master}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{$}\NormalTok{ git log}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{$}\NormalTok{ git revert }\SpecialCharTok{{-}{-}}\NormalTok{no}\SpecialCharTok{{-}}\NormalTok{commit head}
\SpecialCharTok{$}\NormalTok{ git commit }\SpecialCharTok{{-}}\NormalTok{m }\StringTok{"\textless{}message{-}here\textgreater{}"}
\end{Highlighting}
\end{Shaded}
...
\SpecialCharTok{$}\NormalTok{ git add .}
\SpecialCharTok{$}\NormalTok{ git commit }\SpecialCharTok{{-}}\NormalTok{m }\StringTok{"\textless{}message{-}here\textgreater{}"}
\SpecialCharTok{$}\NormalTok{ git push}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{$}\NormalTok{ git checkout }\SpecialCharTok{{-}}\NormalTok{b branch\_name}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{$}\NormalTok{ git checkout switch\_to\_this\_branch}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{$}\NormalTok{ git checkout master}
\SpecialCharTok{$}\NormalTok{ git merge test\_branch\_name}
\end{Highlighting}
\end{Shaded}
